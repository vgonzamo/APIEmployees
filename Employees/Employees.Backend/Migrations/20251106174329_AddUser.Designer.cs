...
namespace Employees.Backend.Migrations
{
    ...
    [Migration("20251106174329_AddUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employees.Shared.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Employees.Shared.Entities.tblEmployees", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Employees.Shared.Entities.User", b =>
                {
                    b.HasOne("Employees.Shared.Entities.City", "City")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Employees.Shared.Entities.User", null)
                        .WithMany()
